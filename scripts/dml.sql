...
INSERT INTO [dbo].[Car] ([CarName], [production_year_start], [production_year_end], [brand_id], [type_id])
VALUES
    ('Honda Accord', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 3, 1), -- Sedan
    ('Chevrolet Bolt', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 4, 2), -- i-Sedan (electric)
    ('Toyota Prius', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 5, 3), -- Hybrid-Sedan
    ('Ford Explorer', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 6, 4), -- SUV
    ('Tesla Model X', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 7, 5), -- i-SUV (electric)
    ('Volkswagen Golf', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 8, 6), -- Hatchback
    ('Nissan Leaf', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 9, 7), -- i-Hatchback (electric)
    ('Ford F-150', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 3, 8), -- Truck
    ('Rivian R1T', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 4, 9), -- i-Truck (electric)
    ('Harley-Davidson Fat Boy', '2022-01-01T00:00:00.0000000Z', '2022-12-31T23:59:59.9999999Z', 5, 10); -- Bike



INSERT INTO [dbo].[CarBlueprint] ([car_id], [part_id], [part_count])
VALUES
    (2, 2, 1),  -- GM-Engine
    (2, 5, 1),  -- 3M-Transmission
    (2, 8, 1),  -- CarCare-Battery
    (2, 14, 1), -- CentalPart-Radiator
    (2, 17, 4), -- 3M-Brake
...
INSERT INTO [dbo].[TransactionRow] ([quantity], [unit_price], [part_batch_id], [transaction_id])
VALUES
    (1, 25.5, 3, 1),
    (2, 30.0, 4, 1),  
    (3, 45.8, 5, 1),  
...
INSERT INTO [dbo].[Stock] ([batch_id], [location_id], [quantity])
VALUES
   (3, 1, 10),
   (4, 2, 15),
   (5, 3, 20),
...
INSERT INTO [dbo].[CarProduction] ([manufactured_date], [color], [manufactured_at_id], [car_id])
VALUES
    ('2000-02-01', 'Red', 2, 2),
    ('2005-06-15', 'Blue', 3, 3),
    ('2010-10-30', 'Black', 4, 4),
    ('2015-03-22', 'White', 5, 5),
    ('2020-08-05', 'Silver', 6, 6),
    ('2002-02-12', 'Gray', 2, 7),
    ('2007-07-18', 'Green', 3, 8),
    ('2012-11-03', 'Yellow', 4, 9),
    ('2017-05-28', 'Orange', 5, 10),
    ('2022-01-10', 'Purple', 6, 1);
